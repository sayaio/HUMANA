        ...
        try {
            ...
            if (result.success) {
                Alert.alert(
                    ...
                    'Akun kamu telah dibuat. Silakan masuk.',
                    [{ text: 'OK', onPress: () => onNavigateToLogin() }]
                );
            } else {
                // Menampilkan error dari database (misal: "Email sudah terdaftar")
                Alert.alert('Gagal Mendaftar', result.message);
            }
        } catch (error) {
            Alert.alert('Error', 'Terjadi kesalahan sistem. Coba lagi nanti.');
        }
    };
