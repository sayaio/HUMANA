        ...
        >
          ...
          <View style={styles.formCard}>
            ...
            <View
              style={[
                styles.inputWrapper,
                { height: 65, flexDirection: 'row', alignItems: 'center' },
              ]}
            >
            ...
            <View style={styles.inputWrapper}>
              ...
              <View style={styles.passwordContainer}>
                <TextInput
                  ...
                  secureTextEntry={securePassword} // <-- Jadi dinamis mengikuti state
                  value={password}
                  onChangeText={setPassword}
                  placeholderTextColor="#A9A9A9"
                />
                {/* Tombol diganti pakai ikon Lucide yang bisa berubah saat diklik */}
                <TouchableOpacity
            ...
            <View style={styles.inputWrapper}>
              ...
              <View style={styles.passwordContainer}>
                <TextInput
                  style={styles.passwordField}
                  placeholder="Masukan password"
                  secureTextEntry={secureConfirmPassword} // <-- Mengikuti state konfirmasi
